...
class SchoolActivity : AppCompatActivity() {
    ...
    private lateinit var schoolAdapter: ContactAdapter
    ...
    private fun init() {
        ...
        schoolAdapter = ContactAdapter()
        schoolRecyclerView = findViewById(R.id.contacts_rv)
        gridLayoutManager = GridLayoutManager(this, 2)

        schoolRecyclerView.layoutManager = gridLayoutManager
