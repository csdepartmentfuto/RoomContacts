...
class FriendsActivity : AppCompatActivity() {
    ...
    private lateinit var friendsAdapter: ContactAdapter
    ...
    private fun init() {
        ...
        friendsAdapter = ContactAdapter()
        friendsRecyclerView = findViewById(R.id.contacts_rv)
        gridLayoutManager = GridLayoutManager(this, 2)

        friendsRecyclerView.layoutManager = gridLayoutManager
