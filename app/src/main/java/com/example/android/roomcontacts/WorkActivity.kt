...
class WorkActivity : AppCompatActivity() {
    ...
    private lateinit var workAdapter: ContactAdapter
    ...
    private fun init() {
        ...
        workAdapter = ContactAdapter()
        workRecyclerView = findViewById(R.id.contacts_rv)
        gridLayoutManager = GridLayoutManager(this, 2)

        workRecyclerView.layoutManager = gridLayoutManager
